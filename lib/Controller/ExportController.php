...
use OCA\JournalNotes\Service\ConversionService;
...
/**
 * Download journal entries in multiple formats.
 */
class ExportController extends Controller
{
    ...
    public function getMarkdown(): DataDownloadResponse
    {
        ...
        return new DataDownloadResponse($markdownString, 'journal.md', 'text/plain');
    }
    ...
    public function getPdf(): DataDownloadResponse
    {
        ...
        return new DataDownloadResponse($pdfString, 'journal.pdf', 'text/plain');
    }
}
