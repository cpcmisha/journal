...
EOT;
    ...
    function addImagePng(&$img, $file, $x, $y, $w = 0.0, $h = 0.0, $is_mask = \false, $mask = null)
    {
        ...
        if (isset($this->imagelist[$file])) {
            ...
            //DEBUG_IMG_TEMP
            //debugpng
            if (defined("OCA\\JournalNotes\\Vendor\\DEBUGPNG") && DEBUGPNG) {
    ...
    protected function addImagePngAlpha($file, $x, $y, $w, $h, $byte)
    {
        ...
        if (extension_loaded("gmagick")) {
            ...
            if ($imagickClonable === null) {
                $imagickClonable = \true;
                if (defined('OCA\JournalNotes\Vendor\Imagick::IMAGICK_EXTVER')) {
    ...
    {
        $doc = new \OCA\JournalNotes\Vendor\Svg\Document();
        ...
        $surface = new \OCA\JournalNotes\Vendor\Svg\Surface\SurfaceCpdf($doc, $this);
        $doc->render($surface);
        $this->restore();
    }
    /**
