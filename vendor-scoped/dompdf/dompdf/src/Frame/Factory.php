 ...
 */
namespace OCA\JournalNotes\Vendor\Dompdf\Frame;
...
use OCA\JournalNotes\Vendor\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use OCA\JournalNotes\Vendor\Dompdf\FrameReflower\Page as PageFrameReflower;
use OCA\JournalNotes\Vendor\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
/**
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator = "OCA\JournalNotes\Vendor\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "OCA\JournalNotes\Vendor\\Dompdf\\FrameReflower\\{$reflower}";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\OCA\JournalNotes\Vendor\Dompdf\Positioner\\' . $type;
