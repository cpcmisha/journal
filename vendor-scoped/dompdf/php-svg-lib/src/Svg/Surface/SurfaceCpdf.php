 ...
 */
namespace OCA\JournalNotes\Vendor\Svg\Surface;

use OCA\JournalNotes\Vendor\Svg\Document;
use OCA\JournalNotes\Vendor\Svg\Style;
class SurfaceCpdf implements SurfaceInterface
{
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        $h = $dimensions["height"];
        if (!$canvas) {
            $canvas = new \OCA\JournalNotes\Vendor\Svg\Surface\CPdf(array(0, 0, $w, $h));
