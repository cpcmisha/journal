 ...
 */
namespace OCA\JournalNotes\Vendor\FontLib\TrueType;

use OCA\JournalNotes\Vendor\FontLib\AdobeFontMetrics;
use OCA\JournalNotes\Vendor\FontLib\Font;
use OCA\JournalNotes\Vendor\FontLib\BinaryStream;
use OCA\JournalNotes\Vendor\FontLib\Table\Table;
use OCA\JournalNotes\Vendor\FontLib\Table\DirectoryEntry;
use OCA\JournalNotes\Vendor\FontLib\Table\Type\glyf;
use OCA\JournalNotes\Vendor\FontLib\Table\Type\name;
use OCA\JournalNotes\Vendor\FontLib\Table\Type\nameRecord;
/**
 * TrueType font file.
 *
...
class File extends BinaryStream
{
    ...
    function parseTableEntries()
    {
        ...
        $class = "OCA\JournalNotes\Vendor\\FontLib\\{$type}\\TableDirectoryEntry";
    ...
    protected function readTable($tag)
    {
        ...
        if (!self::$raw) {
            ...
            $class = "OCA\JournalNotes\Vendor\\FontLib\\Table\\Type\\{$name_canon}";
            if (!isset($this->directory[$tag]) || !@class_exists($class)) {
                return;
            }
        } else {
            $class = "OCA\\JournalNotes\\Vendor\\FontLib\\Table\\Table";
        }
        /** @var Table $table */
