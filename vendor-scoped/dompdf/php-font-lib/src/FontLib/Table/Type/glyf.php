 ...
 */
namespace OCA\JournalNotes\Vendor\FontLib\Table\Type;

use OCA\JournalNotes\Vendor\FontLib\Table\Table;
use OCA\JournalNotes\Vendor\FontLib\Glyph\Outline;
use OCA\JournalNotes\Vendor\FontLib\Glyph\OutlineSimple;
/**
 * `glyf` font table.
 *
 * @package php-font-lib
