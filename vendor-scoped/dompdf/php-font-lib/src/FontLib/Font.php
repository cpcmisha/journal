 ...
 */
namespace OCA\JournalNotes\Vendor\FontLib;
...
class Font
{
    ...
    public static function load($file)
    {
        ...
        switch ($header) {
            ...
            case "true":
            case "typ1":
                $class = "OCA\\JournalNotes\\Vendor\\TrueType\\File";
                break;
            case "OTTO":
                $class = "OCA\\JournalNotes\\Vendor\\OpenType\\File";
                break;
            case "wOFF":
                $class = "OCA\\JournalNotes\\Vendor\\WOFF\\File";
                break;
            case "ttcf":
                $class = "OCA\\JournalNotes\\Vendor\\TrueType\\Collection";
                break;
            // Unknown type or EOT
            default:
                $magicNumber = file_get_contents($file, \false, null, 34, 2);
                if ($magicNumber === "LP") {
                    $class = "OCA\\JournalNotes\\Vendor\\EOT\\File";
                }
        }
        if ($class) {
            $class = "OCA\JournalNotes\Vendor\\FontLib\\{$class}";
