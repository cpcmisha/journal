...
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\CommonMark\Node\Block\Heading;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\CommonMark\Node\Block\ListBlock;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\CommonMark\Node\Block\ListData;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\CommonMark\Node\Block\ListItem;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\CommonMark\Node\Inline\Link;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\HeadingPermalink\HeadingPermalink;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\TableOfContents\Node\TableOfContents;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\TableOfContents\Normalizer\AsIsNormalizerStrategy;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\TableOfContents\Normalizer\FlatNormalizerStrategy;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\TableOfContents\Normalizer\NormalizerStrategyInterface;
use OCA\JournalNotes\Vendor\League\CommonMark\Extension\TableOfContents\Normalizer\RelativeNormalizerStrategy;
use OCA\JournalNotes\Vendor\League\CommonMark\Node\Block\Document;
use OCA\JournalNotes\Vendor\League\CommonMark\Node\NodeIterator;
use OCA\JournalNotes\Vendor\League\CommonMark\Node\RawMarkupContainerInterface;
use OCA\JournalNotes\Vendor\League\CommonMark\Node\StringContainerHelper;
use OCA\JournalNotes\Vendor\League\Config\Exception\InvalidConfigurationException;
