...
class TCPDF_FONTS
{
    ...
    {
        if (!\defined('OCA\JournalNotes\Vendor\K_PATH_FONTS') and \is_dir($fdir = \realpath(\dirname(__FILE__) . '/../fonts'))) {
            if (\substr($fdir, -1) != '/') {
                $fdir .= '/';
            }
            \define('OCA\JournalNotes\Vendor\K_PATH_FONTS', $fdir);
        }
        return \defined('OCA\JournalNotes\Vendor\K_PATH_FONTS') ? \OCA\JournalNotes\Vendor\K_PATH_FONTS : '';
    }
    /**
