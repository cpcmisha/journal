...
class TCPDF_STATIC
{
    ...
    {
        return \tempnam(\OCA\JournalNotes\Vendor\K_PATH_CACHE, '__tcpdf_' . $file_id . '_' . $type . '_' . \md5(TCPDF_STATIC::getRandomSeed()) . '_');
    }
    /**
     * Add "\" before "\", "(" and ")"
    ...
    public static function url_exists($url)
    {
        ...
        $curlopts = \array_replace($curlopts, \OCA\JournalNotes\Vendor\K_CURLOPTS);
