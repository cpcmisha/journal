 ...
 */
// definitions
if (!\defined('OCA\JournalNotes\Vendor\PDF417DEFS')) {
    /**
     * Indicate that definitions for this class are set
     */
    \define('OCA\JournalNotes\Vendor\PDF417DEFS', \true);
    // -----------------------------------------------------
    /**
     * Row height respect X dimension of single module
     */
    \define('OCA\JournalNotes\Vendor\ROWHEIGHT', 4);
    /**
     * Horizontal quiet zone in modules
     */
    \define('OCA\JournalNotes\Vendor\QUIETH', 2);
    /**
     * Vertical quiet zone in modules
     */
    \define('OCA\JournalNotes\Vendor\QUIETV', 2);
}
// end of definitions
// #*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
/**
...
class PDF417
{
    ...
    public function __construct($code, $ecl = -1, $aspectratio = 2, $macro = array())
    {
        ...
        $nce = $numcw + $errsize + 1;
        $cols = \round((\sqrt(4761 + 68 * $aspectratio * \OCA\JournalNotes\Vendor\ROWHEIGHT * $nce) - 69) / 34);
        // adjust cols
        if ($cols < 1) {
            $cols = 1;
        } elseif ($cols > 30) {
        ...
        $pstart = \str_repeat('0', \OCA\JournalNotes\Vendor\QUIETH) . $this->start_pattern;
        $pstop = $this->stop_pattern . \str_repeat('0', \OCA\JournalNotes\Vendor\QUIETH);
        $barcode_array['num_rows'] = $rows * \OCA\JournalNotes\Vendor\ROWHEIGHT + 2 * \OCA\JournalNotes\Vendor\QUIETV;
        $barcode_array['num_cols'] = ($cols + 2) * 17 + 35 + 2 * \OCA\JournalNotes\Vendor\QUIETH;
        $barcode_array['bcode'] = array();
        // build rows for vertical quiet zone
        if (\OCA\JournalNotes\Vendor\QUIETV > 0) {
            $empty_row = \array_fill(0, $barcode_array['num_cols'], 0);
            for ($i = 0; $i < \OCA\JournalNotes\Vendor\QUIETV; ++$i) {
        ...
        for ($r = 0; $r < $rows; ++$r) {
            ...
            for ($h = 0; $h < \OCA\JournalNotes\Vendor\ROWHEIGHT; ++$h) {
