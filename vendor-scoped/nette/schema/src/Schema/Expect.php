...
namespace OCA\JournalNotes\Vendor\Nette\Schema;

use OCA\JournalNotes\Vendor\Nette;
use OCA\JournalNotes\Vendor\Nette\Schema\Elements\AnyOf;
use OCA\JournalNotes\Vendor\Nette\Schema\Elements\Structure;
use OCA\JournalNotes\Vendor\Nette\Schema\Elements\Type;
/**
 * Schema generator.
 *
